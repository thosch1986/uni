 ...
 *
 * This routine generates an "HTTP/1.0 500 Internal Server Error" status line
 * and a corresponding HTML error page on the given file descriptor, which should
 * normally be the client connection.
 *
 * @param client  The output file descriptor.
 */
void httpInternalServerErrorToFd(int client);
